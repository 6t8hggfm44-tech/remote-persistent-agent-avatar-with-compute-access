...
Current state: Pete authorized implementation with EA integration set aside. Presence 0.2 has a text adapter verified through two live calls; read `docs/10-live-text-connection.md` first. This file does not authorize new paid services or deployment.
